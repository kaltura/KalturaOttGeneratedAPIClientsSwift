...
open class TreeAnswer: ObjectBase {

	public class TreeAnswerTokenizer: ObjectBase.ObjectBaseTokenizer {
	...
	public var answerId: String? = nil
	/**  The answer text to display to the user.  */
	public var text: String? = nil


	public func setMultiRequestToken(answerId: String) {
		self.dict["answerId"] = answerId
	}
	...
	public override func populate(_ dict: [String: Any]) throws {
		...
		// set members values:
		if dict["answerId"] != nil {
			answerId = dict["answerId"] as? String
		}
		if dict["text"] != nil {
