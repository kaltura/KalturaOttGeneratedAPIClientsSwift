...
open class HouseholdDeviceFamilyLimitations: DeviceFamilyBase {
	...
	public class HouseholdDeviceFamilyLimitationsTokenizer: DeviceFamilyBase.DeviceFamilyBaseTokenizer {
		...
		public var isDefaultFrequencyLimit: BaseTokenizedObject {
			get {
				return self.append("isDefaultFrequencyLimit") 
			}
		}
	}
	...
	/**  Is the Allowed device change frequency code for this family is default value or
	  not  */
	public var isDefaultFrequencyLimit: Bool? = nil
	...
	public func setMultiRequestToken(isDefaultFrequencyLimit: String) {
		self.dict["isDefaultFrequencyLimit"] = isDefaultFrequencyLimit
	}
	...
	public override func populate(_ dict: [String: Any]) throws {
		...
		if dict["isDefaultFrequencyLimit"] != nil {
			isDefaultFrequencyLimit = dict["isDefaultFrequencyLimit"] as? Bool
		}
