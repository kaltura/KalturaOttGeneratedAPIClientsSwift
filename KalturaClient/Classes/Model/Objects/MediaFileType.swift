...
open class MediaFileType: ObjectBase {
	...
	public class MediaFileTypeTokenizer: ObjectBase.ObjectBaseTokenizer {
		...
		public var dynamicDataKeys: BaseTokenizedObject {
			get {
				return self.append("dynamicDataKeys") 
			}
		}
	}
	...
	/**  List of comma separated keys allowed to be used as KalturaMediaFile&amp;#39;s
	  dynamic data keys  */
	public var dynamicDataKeys: String? = nil
	...
	public func setMultiRequestToken(dynamicDataKeys: String) {
		self.dict["dynamicDataKeys"] = dynamicDataKeys
	}
	...
	public override func populate(_ dict: [String: Any]) throws {
		...
		if dict["dynamicDataKeys"] != nil {
			dynamicDataKeys = dict["dynamicDataKeys"] as? String
		}
	...
	internal override func toDictionary() -> [String: Any] {
		...
		if(dynamicDataKeys != nil) {
			dict["dynamicDataKeys"] = dynamicDataKeys!
		}
		return dict
	}
}
