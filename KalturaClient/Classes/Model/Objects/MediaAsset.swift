...
open class MediaAsset: Asset {
	...
	public class MediaAssetTokenizer: Asset.AssetTokenizer {
		...
		public func liveToVod<T: LiveToVodInfoAsset.LiveToVodInfoAssetTokenizer>() -> T {
			return T(self.append("liveToVod"))
		}
	}
	...
	public var liveToVod: LiveToVodInfoAsset? = nil
	...
	public override func populate(_ dict: [String: Any]) throws {
		...
		if dict["liveToVod"] != nil {
		liveToVod = try JSONParser.parse(object: dict["liveToVod"] as! [String: Any])		}
	...
	internal override func toDictionary() -> [String: Any] {
		...
		if(liveToVod != nil) {
			dict["liveToVod"] = liveToVod!.toDictionary()
		}
		return dict
	}
}
