...
open class MediaFile: AssetFile {
	...
	public class MediaFileTokenizer: AssetFile.AssetFileTokenizer {
		...
		public var dynamicData: DictionaryTokenizedObject<StringValueArray.StringValueArrayTokenizer> {
			get {
				return DictionaryTokenizedObject<StringValueArray.StringValueArrayTokenizer>(self.append("dynamicData"))
			}
		}
	}
	...
	public var dynamicData: Dictionary<String, StringValueArray>? = nil
