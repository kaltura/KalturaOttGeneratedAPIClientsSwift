...
open class BasePartnerConfiguration: PartnerConfiguration {
	...
	public class BasePartnerConfigurationTokenizer: PartnerConfiguration.PartnerConfigurationTokenizer {
		...
		public var epgFeatureVersion: BaseTokenizedObject {
			get {
				return self.append("epgFeatureVersion") 
			}
		}
	}
	...
	public var epgFeatureVersion: Int? = nil
	...
	public func setMultiRequestToken(epgFeatureVersion: String) {
		self.dict["epgFeatureVersion"] = epgFeatureVersion
	}
	...
	public override func populate(_ dict: [String: Any]) throws {
		...
		if dict["epgFeatureVersion"] != nil {
			epgFeatureVersion = dict["epgFeatureVersion"] as? Int
		}
	...
	internal override func toDictionary() -> [String: Any] {
		...
		if(epgFeatureVersion != nil) {
			dict["epgFeatureVersion"] = epgFeatureVersion!
		}
		return dict
	}
}
