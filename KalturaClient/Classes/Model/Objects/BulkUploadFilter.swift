...
open class BulkUploadFilter: Filter {
	...
	public class BulkUploadFilterTokenizer: Filter.FilterTokenizer {
		...
		public var includeResultsEqual: BaseTokenizedObject {
			get {
				return self.append("includeResultsEqual") 
			}
		}
	}
	...
	/**  Indicates whether to include detailed results data (from Couchbase) in the
	  ...
	  compatibility.  */
	public var includeResultsEqual: Bool? = nil
	...
	public func setMultiRequestToken(includeResultsEqual: String) {
		self.dict["includeResultsEqual"] = includeResultsEqual
	}
	...
	public override func populate(_ dict: [String: Any]) throws {
		...
		if dict["includeResultsEqual"] != nil {
			includeResultsEqual = dict["includeResultsEqual"] as? Bool
		}
	...
	internal override func toDictionary() -> [String: Any] {
		...
		if(includeResultsEqual != nil) {
			dict["includeResultsEqual"] = includeResultsEqual!
		}
		return dict
	}
}
