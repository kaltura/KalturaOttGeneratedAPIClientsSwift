...
/**  Coupon promotion  */
open class CouponPromotion: BasePromotion {

	public class CouponPromotionTokenizer: BasePromotion.BasePromotionTokenizer {
	...
	public var couponGroupId: Int64? = nil
	...
	public override func populate(_ dict: [String: Any]) throws {
		...
		if dict["couponGroupId"] != nil {
			couponGroupId = Int64("\(dict["couponGroupId"]!)")
		}
