...
open class ShopPreActionCondition: BasePreActionCondition {

	public class ShopPreActionConditionTokenizer: BasePreActionCondition.BasePreActionConditionTokenizer {
	...
	public var shopAssetUserRuleId: Int? = nil
	...
	public override func populate(_ dict: [String: Any]) throws {
		...
		if dict["shopAssetUserRuleId"] != nil {
			shopAssetUserRuleId = dict["shopAssetUserRuleId"] as? Int
		}
