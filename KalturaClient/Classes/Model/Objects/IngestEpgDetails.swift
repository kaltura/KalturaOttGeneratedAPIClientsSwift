...
open class IngestEpgDetails: IngestEpg {

	public class IngestEpgDetailsTokenizer: IngestEpg.IngestEpgTokenizer {
		...
		public func aggregations<T: IngestEpgDetailsAggregation.IngestEpgDetailsAggregationTokenizer>() -> T {
	...
	/**  Aggregated counters  */
	public var aggregations: IngestEpgDetailsAggregation? = nil
