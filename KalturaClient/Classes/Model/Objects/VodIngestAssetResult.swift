...
open class VodIngestAssetResult: ObjectBase {
	...
	public class VodIngestAssetResultTokenizer: ObjectBase.ObjectBaseTokenizer {
		...
		public var fileUploadDate: BaseTokenizedObject {
			get {
				return self.append("fileUploadDate") 
			}
		}
		
		public var processingStartDate: BaseTokenizedObject {
			get {
				return self.append("processingStartDate") 
			}
		}
		
		public var processingCompletionDate: BaseTokenizedObject {
			get {
				return self.append("processingCompletionDate") 
			}
		}
	}
	...
	public var fileUploadDate: Int64? = nil
	...
	public func setMultiRequestToken(fileUploadDate: String) {
		self.dict["fileUploadDate"] = fileUploadDate
	}
	
	public func setMultiRequestToken(processingStartDate: String) {
		self.dict["processingStartDate"] = processingStartDate
	}
	
	public func setMultiRequestToken(processingCompletionDate: String) {
		self.dict["processingCompletionDate"] = processingCompletionDate
	}
	...
	public override func populate(_ dict: [String: Any]) throws {
		...
		if dict["fileUploadDate"] != nil {
			fileUploadDate = Int64("\(dict["fileUploadDate"]!)")
		}
		if dict["processingStartDate"] != nil {
			processingStartDate = Int64("\(dict["processingStartDate"]!)")
		}
		if dict["processingCompletionDate"] != nil {
			processingCompletionDate = Int64("\(dict["processingCompletionDate"]!)")
		}
	...
	internal override func toDictionary() -> [String: Any] {
		...
		if(fileUploadDate != nil) {
			dict["fileUploadDate"] = fileUploadDate!
		}
		if(processingStartDate != nil) {
			dict["processingStartDate"] = processingStartDate!
		}
		if(processingCompletionDate != nil) {
			dict["processingCompletionDate"] = processingCompletionDate!
		}
		return dict
	}
}
