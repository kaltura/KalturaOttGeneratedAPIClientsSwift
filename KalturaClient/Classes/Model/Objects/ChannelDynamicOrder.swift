...
open class ChannelDynamicOrder: BaseChannelOrder {

	public class ChannelDynamicOrderTokenizer: BaseChannelOrder.BaseChannelOrderTokenizer {
	...
	public override func populate(_ dict: [String: Any]) throws {
		...
		if dict["orderBy"] != nil {
			orderBy = MetaTagOrderBy(rawValue: "\(dict["orderBy"]!)")
		}
