...
open class SegmentationType: ObjectBase {
	...
	public class SegmentationTypeTokenizer: ObjectBase.ObjectBaseTokenizer {
		...
		public var conditionsOperator: BaseTokenizedObject {
			get {
				return self.append("conditionsOperator") 
			}
		}
		...
		public var executeDate: BaseTokenizedObject {
			get {
				return self.append("executeDate") 
			}
		}
		...
		public var scope: BaseTokenizedObject {
			get {
				return self.append("scope") 
			}
		}
	}
	...
	/**  Boolean operator between segmentation type&amp;#39;s conditions - defaults to
	  &amp;quot;And&amp;quot;  */
	public var conditionsOperator: BooleanOperator? = nil
	/**  Segmentation conditions - can be empty  */
	...
	public var executeDate: Int64? = nil
	...
	public var scope: ConditionScope? = nil
	...
	public func setMultiRequestToken(conditionsOperator: String) {
		self.dict["conditionsOperator"] = conditionsOperator
	}
	...
	public func setMultiRequestToken(executeDate: String) {
		self.dict["executeDate"] = executeDate
	}
	...
	public func setMultiRequestToken(scope: String) {
		self.dict["scope"] = scope
	}
	...
	public override func populate(_ dict: [String: Any]) throws {
		...
		if dict["conditionsOperator"] != nil {
			conditionsOperator = BooleanOperator(rawValue: "\(dict["conditionsOperator"]!)")
		}
		if dict["actions"] != nil {
		...
		if dict["executeDate"] != nil {
			executeDate = Int64("\(dict["executeDate"]!)")
		}
		if dict["version"] != nil {
		...
		if dict["scope"] != nil {
			scope = ConditionScope(rawValue: "\(dict["scope"]!)")
		}
	...
	internal override func toDictionary() -> [String: Any] {
		...
		if(conditionsOperator != nil) {
			dict["conditionsOperator"] = conditionsOperator!.rawValue
		}
		if(actions != nil) {
