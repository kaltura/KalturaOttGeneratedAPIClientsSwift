...
/**  Sms adapter profile  */
open class SmsAdapterProfile: OTTObjectSupportNullable {

	public class SmsAdapterProfileTokenizer: OTTObjectSupportNullable.OTTObjectSupportNullableTokenizer {
