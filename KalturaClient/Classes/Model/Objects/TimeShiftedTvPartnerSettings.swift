...
open class TimeShiftedTvPartnerSettings: ObjectBase {
	...
	public class TimeShiftedTvPartnerSettingsTokenizer: ObjectBase.ObjectBaseTokenizer {
		...
		public var personalizedRecording: BaseTokenizedObject {
			get {
				return self.append("personalizedRecording") 
			}
		}
		
		public var maxRecordingConcurrency: BaseTokenizedObject {
			get {
				return self.append("maxRecordingConcurrency") 
			}
		}
		
		public var maxConcurrencyMargin: BaseTokenizedObject {
			get {
				return self.append("maxConcurrencyMargin") 
			}
		}
		
		public var shouldRoundStopRecordingsBySeconds: BaseTokenizedObject {
			get {
				return self.append("shouldRoundStopRecordingsBySeconds") 
			}
		}
	}
	...
	/**  When using padded and immediate recordings, define if end date of recording
	  ...
	  minutes, FALSE.  */
	public var shouldRoundStopRecordingsBySeconds: Bool? = nil
	...
	public func setMultiRequestToken(personalizedRecording: String) {
		self.dict["personalizedRecording"] = personalizedRecording
	}
	
	public func setMultiRequestToken(maxRecordingConcurrency: String) {
		self.dict["maxRecordingConcurrency"] = maxRecordingConcurrency
	}
	
	public func setMultiRequestToken(maxConcurrencyMargin: String) {
		self.dict["maxConcurrencyMargin"] = maxConcurrencyMargin
	}
	
	public func setMultiRequestToken(shouldRoundStopRecordingsBySeconds: String) {
		self.dict["shouldRoundStopRecordingsBySeconds"] = shouldRoundStopRecordingsBySeconds
	}
	...
	public override func populate(_ dict: [String: Any]) throws {
		...
		if dict["personalizedRecording"] != nil {
			personalizedRecording = dict["personalizedRecording"] as? Bool
		}
		if dict["maxRecordingConcurrency"] != nil {
			maxRecordingConcurrency = dict["maxRecordingConcurrency"] as? Int
		}
		if dict["maxConcurrencyMargin"] != nil {
			maxConcurrencyMargin = dict["maxConcurrencyMargin"] as? Int
		}
		if dict["shouldRoundStopRecordingsBySeconds"] != nil {
			shouldRoundStopRecordingsBySeconds = dict["shouldRoundStopRecordingsBySeconds"] as? Bool
		}
	...
	internal override func toDictionary() -> [String: Any] {
		...
		if(personalizedRecording != nil) {
			dict["personalizedRecording"] = personalizedRecording!
		}
		if(maxRecordingConcurrency != nil) {
			dict["maxRecordingConcurrency"] = maxRecordingConcurrency!
		}
		if(maxConcurrencyMargin != nil) {
			dict["maxConcurrencyMargin"] = maxConcurrencyMargin!
		}
		if(shouldRoundStopRecordingsBySeconds != nil) {
			dict["shouldRoundStopRecordingsBySeconds"] = shouldRoundStopRecordingsBySeconds!
		}
		return dict
	}
}
