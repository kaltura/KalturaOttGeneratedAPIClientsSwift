...
open class RecordingFilter: Filter {
	...
	public class RecordingFilterTokenizer: Filter.FilterTokenizer {
		...
		public var contentFilteringEnforced: BaseTokenizedObject {
			get {
				return self.append("contentFilteringEnforced") 
			}
		}
	}
	...
	public var contentFilteringEnforced: Bool? = nil
	...
	public func setMultiRequestToken(contentFilteringEnforced: String) {
		self.dict["contentFilteringEnforced"] = contentFilteringEnforced
	}
	...
	public override func populate(_ dict: [String: Any]) throws {
		...
		if dict["contentFilteringEnforced"] != nil {
			contentFilteringEnforced = dict["contentFilteringEnforced"] as? Bool
		}
	...
	internal override func toDictionary() -> [String: Any] {
		...
		if(contentFilteringEnforced != nil) {
			dict["contentFilteringEnforced"] = contentFilteringEnforced!
		}
		return dict
	}
}
