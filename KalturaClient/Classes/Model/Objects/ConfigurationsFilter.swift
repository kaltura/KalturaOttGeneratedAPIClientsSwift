...
open class ConfigurationsFilter: Filter {

	public class ConfigurationsFilterTokenizer: Filter.FilterTokenizer {
	...
	public override func populate(_ dict: [String: Any]) throws {
		...
		// set members values:
		if dict["configurationGroupIdEqual"] != nil {
			configurationGroupIdEqual = dict["configurationGroupIdEqual"] as? String
		}
	...
	internal override func toDictionary() -> [String: Any] {
		...
		if(configurationGroupIdEqual != nil) {
			dict["configurationGroupIdEqual"] = configurationGroupIdEqual!
		}
		return dict
	}
}
