...
/**  Filters assets based on an enum metadata field matching one of the values.      
  ...
  of Enum will fail.  */
open class EnumMetaConstraint: BaseAttributeConstraint {

	public class EnumMetaConstraintTokenizer: BaseAttributeConstraint.BaseAttributeConstraintTokenizer {
