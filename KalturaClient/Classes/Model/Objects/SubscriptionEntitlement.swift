...
open class SubscriptionEntitlement: Entitlement {
	...
	public class SubscriptionEntitlementTokenizer: Entitlement.EntitlementTokenizer {
		...
		public var isFlexiblePricePlan: BaseTokenizedObject {
			get {
				return self.append("isFlexiblePricePlan") 
			}
		}
	}
	...
	/**  Indicates whether the subscription is now within the flexible price plan
	  lifecycle or not  */
	public var isFlexiblePricePlan: Bool? = nil
	...
	public func setMultiRequestToken(isFlexiblePricePlan: String) {
		self.dict["isFlexiblePricePlan"] = isFlexiblePricePlan
	}
	...
	public override func populate(_ dict: [String: Any]) throws {
		...
		if dict["isFlexiblePricePlan"] != nil {
			isFlexiblePricePlan = dict["isFlexiblePricePlan"] as? Bool
		}
