...
open class Subscription: OTTObjectSupportNullable {
	...
	public class SubscriptionTokenizer: OTTObjectSupportNullable.OTTObjectSupportNullableTokenizer {
		...
		public var flexiblePricePlanId: BaseTokenizedObject {
			get {
				return self.append("flexiblePricePlanId") 
			}
		}
	...
	public var flexiblePricePlanId: Int64? = nil
	...
	public func setMultiRequestToken(flexiblePricePlanId: String) {
		self.dict["flexiblePricePlanId"] = flexiblePricePlanId
	}
	...
	public override func populate(_ dict: [String: Any]) throws {
		...
		if dict["flexiblePricePlanId"] != nil {
			flexiblePricePlanId = Int64("\(dict["flexiblePricePlanId"]!)")
		}
	...
	internal override func toDictionary() -> [String: Any] {
		...
		if(flexiblePricePlanId != nil) {
			dict["flexiblePricePlanId"] = flexiblePricePlanId!
		}
