...
open class ChannelSlidingWindowOrder: BaseChannelOrder {

	public class ChannelSlidingWindowOrderTokenizer: BaseChannelOrder.BaseChannelOrderTokenizer {
	...
	/**  Order By  */
	public var orderBy: ChannelSlidingWindowOrderByType? = nil
	...
	public override func populate(_ dict: [String: Any]) throws {
		...
		if dict["orderBy"] != nil {
			orderBy = ChannelSlidingWindowOrderByType(rawValue: "\(dict["orderBy"]!)")
		}
