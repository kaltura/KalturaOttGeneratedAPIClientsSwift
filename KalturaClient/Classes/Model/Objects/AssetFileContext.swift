...
open class AssetFileContext: ObjectBase {

	public class AssetFileContextTokenizer: ObjectBase.ObjectBaseTokenizer {
	...
	/**  viewLifeCycle  */
	public var viewLifeCycle: String? = nil
	/**  fullLifeCycle  */
	...
	public override func populate(_ dict: [String: Any]) throws {
		...
		if dict["viewLifeCycle"] != nil {
			viewLifeCycle = dict["viewLifeCycle"] as? String
		}
		if dict["fullLifeCycle"] != nil {
			fullLifeCycle = dict["fullLifeCycle"] as? String
		}
