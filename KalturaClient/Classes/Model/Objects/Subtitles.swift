...
open class Subtitles: ObjectBase {
	...
	public class SubtitlesTokenizer: ObjectBase.ObjectBaseTokenizer {
		...
		public var detectedLanguage: BaseTokenizedObject {
			get {
				return self.append("detectedLanguage") 
			}
		}
	}
	...
	public var detectedLanguage: String? = nil
	...
	public func setMultiRequestToken(detectedLanguage: String) {
		self.dict["detectedLanguage"] = detectedLanguage
	}
	...
	public override func populate(_ dict: [String: Any]) throws {
		...
		if dict["detectedLanguage"] != nil {
			detectedLanguage = dict["detectedLanguage"] as? String
		}
	...
	internal override func toDictionary() -> [String: Any] {
		...
		if(detectedLanguage != nil) {
			dict["detectedLanguage"] = detectedLanguage!
		}
		return dict
	}
}
