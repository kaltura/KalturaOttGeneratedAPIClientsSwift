...
open class SubscriptionFilter: Filter {
	...
	public class SubscriptionFilterTokenizer: Filter.FilterTokenizer {
		...
		public var dependencyTypeIn: BaseTokenizedObject {
			get {
				return self.append("dependencyTypeIn") 
			}
		}
	...
	public var dependencyTypeIn: String? = nil
	...
	public func setMultiRequestToken(dependencyTypeIn: String) {
		self.dict["dependencyTypeIn"] = dependencyTypeIn
	}
	...
	public override func populate(_ dict: [String: Any]) throws {
		...
		if dict["dependencyTypeIn"] != nil {
			dependencyTypeIn = dict["dependencyTypeIn"] as? String
		}
	...
	internal override func toDictionary() -> [String: Any] {
		...
		if(dependencyTypeIn != nil) {
			dict["dependencyTypeIn"] = dependencyTypeIn!
		}
		if(nameContains != nil) {
