...
open class IotClientConfiguration: ObjectBase {
	...
	public class IotClientConfigurationTokenizer: ObjectBase.ObjectBaseTokenizer {
		...
		public var topics: ArrayTokenizedObject<KeyValue.KeyValueTokenizer> {
			get {
				return ArrayTokenizedObject<KeyValue.KeyValueTokenizer>(self.append("topics"))
			} 
		}
	...
	/**  topics  */
	public var topics: Array<KeyValue>? = nil
	/**  status  */
