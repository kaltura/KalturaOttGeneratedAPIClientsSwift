...
open class SeriesRecording: ObjectBase {
	...
	public class SeriesRecordingTokenizer: ObjectBase.ObjectBaseTokenizer {
		...
		public var householdSpecificSeriesStartTimeOffset: BaseTokenizedObject {
			get {
				return self.append("householdSpecificSeriesStartTimeOffset") 
			}
		}
		
		public var householdSpecificSeriesEndTimeOffset: BaseTokenizedObject {
			get {
				return self.append("householdSpecificSeriesEndTimeOffset") 
			}
		}
	}
	...
	public var householdSpecificSeriesStartTimeOffset: Int? = nil
	/**  Household specific end time of the recording  */
	public var householdSpecificSeriesEndTimeOffset: Int? = nil
	...
	public func setMultiRequestToken(householdSpecificSeriesStartTimeOffset: String) {
		self.dict["householdSpecificSeriesStartTimeOffset"] = householdSpecificSeriesStartTimeOffset
	}
	
	public func setMultiRequestToken(householdSpecificSeriesEndTimeOffset: String) {
		self.dict["householdSpecificSeriesEndTimeOffset"] = householdSpecificSeriesEndTimeOffset
	}
	...
	public override func populate(_ dict: [String: Any]) throws {
		...
		if dict["householdSpecificSeriesStartTimeOffset"] != nil {
			householdSpecificSeriesStartTimeOffset = dict["householdSpecificSeriesStartTimeOffset"] as? Int
		}
		if dict["householdSpecificSeriesEndTimeOffset"] != nil {
			householdSpecificSeriesEndTimeOffset = dict["householdSpecificSeriesEndTimeOffset"] as? Int
		}
	...
	internal override func toDictionary() -> [String: Any] {
		...
		if(householdSpecificSeriesStartTimeOffset != nil) {
			dict["householdSpecificSeriesStartTimeOffset"] = householdSpecificSeriesStartTimeOffset!
		}
		if(householdSpecificSeriesEndTimeOffset != nil) {
			dict["householdSpecificSeriesEndTimeOffset"] = householdSpecificSeriesEndTimeOffset!
		}
		return dict
	}
}
