...
open class SSOAdapterProfile: ObjectBase {
	...
	public class SSOAdapterProfileTokenizer: ObjectBase.ObjectBaseTokenizer {
		...
		public var adapterGrpcAddress: BaseTokenizedObject {
			get {
				return self.append("adapterGrpcAddress") 
			}
		}
	}
	...
	public var adapterGrpcAddress: String? = nil
	...
	public func setMultiRequestToken(adapterGrpcAddress: String) {
		self.dict["adapterGrpcAddress"] = adapterGrpcAddress
	}
	...
	public override func populate(_ dict: [String: Any]) throws {
		...
		if dict["adapterGrpcAddress"] != nil {
			adapterGrpcAddress = dict["adapterGrpcAddress"] as? String
		}
	...
	internal override func toDictionary() -> [String: Any] {
		...
		if(adapterGrpcAddress != nil) {
			dict["adapterGrpcAddress"] = adapterGrpcAddress!
		}
		return dict
	}
}
