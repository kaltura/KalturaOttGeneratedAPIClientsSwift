...
open class ConcurrencyPartnerConfig: PartnerConfiguration {
	...
	public class ConcurrencyPartnerConfigTokenizer: PartnerConfiguration.PartnerConfigurationTokenizer {
		...
		public var excludeFreeContentFromConcurrency: BaseTokenizedObject {
			get {
				return self.append("excludeFreeContentFromConcurrency") 
			}
		}
	}
	...
	public var excludeFreeContentFromConcurrency: Bool? = nil
	...
	public func setMultiRequestToken(excludeFreeContentFromConcurrency: String) {
		self.dict["excludeFreeContentFromConcurrency"] = excludeFreeContentFromConcurrency
	}
	...
	public override func populate(_ dict: [String: Any]) throws {
		...
		if dict["excludeFreeContentFromConcurrency"] != nil {
			excludeFreeContentFromConcurrency = dict["excludeFreeContentFromConcurrency"] as? Bool
		}
	...
	internal override func toDictionary() -> [String: Any] {
		...
		if(excludeFreeContentFromConcurrency != nil) {
			dict["excludeFreeContentFromConcurrency"] = excludeFreeContentFromConcurrency!
		}
		return dict
	}
}
