...
public final class SmsAdapterProfileService{
	...
	public static func list() -> RequestBuilder<SmsAdapterProfileListResponse, SmsAdapterProfileListResponse.SmsAdapterProfileListResponseTokenizer, ListTokenizer> {
