...
public final class AssetFileService{
	...
	public static func playManifest(partnerId: Int, assetId: String, assetType: AssetType, assetFileId: Int64, contextType: PlaybackContextType) -> RequestBuilder<String, BaseTokenizedObject, PlayManifestTokenizer> {
	...
	public static func playManifest(partnerId: Int, assetId: String, assetType: AssetType, assetFileId: Int64, contextType: PlaybackContextType, ks: String?) -> RequestBuilder<String, BaseTokenizedObject, PlayManifestTokenizer> {
		let request: RequestBuilder<String, BaseTokenizedObject, PlayManifestTokenizer> = RequestBuilder<String, BaseTokenizedObject, PlayManifestTokenizer>(service: "assetfile", action: "playManifest")
