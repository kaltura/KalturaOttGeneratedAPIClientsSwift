...
public final class SegmentationTypeService{
	...
	public static func getPartnerConfiguration() -> RequestBuilder<SegmentationPartnerConfiguration, SegmentationPartnerConfiguration.SegmentationPartnerConfigurationTokenizer, GetPartnerConfigurationTokenizer> {
		let request: RequestBuilder<SegmentationPartnerConfiguration, SegmentationPartnerConfiguration.SegmentationPartnerConfigurationTokenizer, GetPartnerConfigurationTokenizer> = RequestBuilder<SegmentationPartnerConfiguration, SegmentationPartnerConfiguration.SegmentationPartnerConfigurationTokenizer, GetPartnerConfigurationTokenizer>(service: "segmentationtype", action: "getPartnerConfiguration")
	...
	public class UpdatePartnerConfigurationTokenizer: ClientTokenizer  {
		...
		public func configuration<T: SegmentationPartnerConfiguration.SegmentationPartnerConfigurationTokenizer>() -> T {
			return T(self.append("configuration"))
		}
	}

	/**  Sets partner configuration for segments configuration  */
	public static func updatePartnerConfiguration(configuration: SegmentationPartnerConfiguration) -> RequestBuilder<Bool, BaseTokenizedObject, UpdatePartnerConfigurationTokenizer> {
		let request: RequestBuilder<Bool, BaseTokenizedObject, UpdatePartnerConfigurationTokenizer> = RequestBuilder<Bool, BaseTokenizedObject, UpdatePartnerConfigurationTokenizer>(service: "segmentationtype", action: "updatePartnerConfiguration")
