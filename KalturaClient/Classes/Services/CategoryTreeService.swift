...
public final class CategoryTreeService{
	...
	public static func getByVersion(versionId: Int64?, deviceFamilyId: Int?) -> RequestBuilder<CategoryTree, CategoryTree.CategoryTreeTokenizer, GetByVersionTokenizer> {
		return getByVersion(versionId: versionId, deviceFamilyId: deviceFamilyId, filter: false)
	}

	/**  Retrieve default category tree of deviceFamilyId by KS or specific one if
	  versionId is set.  */
	public static func getByVersion(versionId: Int64?, deviceFamilyId: Int?, filter: Bool?) -> RequestBuilder<CategoryTree, CategoryTree.CategoryTreeTokenizer, GetByVersionTokenizer> {
