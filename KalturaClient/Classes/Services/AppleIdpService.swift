...
public final class AppleIdpService{
	...
	public static func attach(idToken: String) -> RequestBuilder<SocialAttachStatus, SocialAttachStatus.SocialAttachStatusTokenizer, AttachTokenizer> {
		let request: RequestBuilder<SocialAttachStatus, SocialAttachStatus.SocialAttachStatusTokenizer, AttachTokenizer> = RequestBuilder<SocialAttachStatus, SocialAttachStatus.SocialAttachStatusTokenizer, AttachTokenizer>(service: "appleidp", action: "attach")
	...
	public static func detach() -> RequestBuilder<SocialAttachStatus, SocialAttachStatus.SocialAttachStatusTokenizer, DetachTokenizer> {
		let request: RequestBuilder<SocialAttachStatus, SocialAttachStatus.SocialAttachStatusTokenizer, DetachTokenizer> = RequestBuilder<SocialAttachStatus, SocialAttachStatus.SocialAttachStatusTokenizer, DetachTokenizer>(service: "appleidp", action: "detach")
	...
	public static func getServiceId() -> RequestBuilder<SocialServiceId, SocialServiceId.SocialServiceIdTokenizer, GetServiceIdTokenizer> {
		let request: RequestBuilder<SocialServiceId, SocialServiceId.SocialServiceIdTokenizer, GetServiceIdTokenizer> = RequestBuilder<SocialServiceId, SocialServiceId.SocialServiceIdTokenizer, GetServiceIdTokenizer>(service: "appleidp", action: "getServiceId")
	...
	public static func isAttached() -> RequestBuilder<SocialAttachStatus, SocialAttachStatus.SocialAttachStatusTokenizer, IsAttachedTokenizer> {
		let request: RequestBuilder<SocialAttachStatus, SocialAttachStatus.SocialAttachStatusTokenizer, IsAttachedTokenizer> = RequestBuilder<SocialAttachStatus, SocialAttachStatus.SocialAttachStatusTokenizer, IsAttachedTokenizer>(service: "appleidp", action: "isAttached")
	...
	public static func login(partnerId: Int, idToken: String, extraParams: Dictionary<String, StringValue>?, udid: String?) -> RequestBuilder<LoginResponse, LoginResponse.LoginResponseTokenizer, LoginTokenizer> {
		let request: RequestBuilder<LoginResponse, LoginResponse.LoginResponseTokenizer, LoginTokenizer> = RequestBuilder<LoginResponse, LoginResponse.LoginResponseTokenizer, LoginTokenizer>(service: "appleidp", action: "login")
	...
	public static func setServiceId(serviceId: String) -> RequestBuilder<SocialServiceId, SocialServiceId.SocialServiceIdTokenizer, SetServiceIdTokenizer> {
		let request: RequestBuilder<SocialServiceId, SocialServiceId.SocialServiceIdTokenizer, SetServiceIdTokenizer> = RequestBuilder<SocialServiceId, SocialServiceId.SocialServiceIdTokenizer, SetServiceIdTokenizer>(service: "appleidp", action: "setServiceId")
