...
public final class AssetService{
	...
	public class BulkGetPlaybackContextTokenizer: ClientTokenizer  {
		
		public func request<T: BulkPlaybackContextRequest.BulkPlaybackContextRequestTokenizer>() -> T {
			return T(self.append("request"))
		}
	}

	/**  Returns playback contexts for multiple assets in a single request  */
	public static func bulkGetPlaybackContext(request: BulkPlaybackContextRequest) -> RequestBuilder<BulkPlaybackContextResponse, BulkPlaybackContextResponse.BulkPlaybackContextResponseTokenizer, BulkGetPlaybackContextTokenizer> {
		let request: RequestBuilder<BulkPlaybackContextResponse, BulkPlaybackContextResponse.BulkPlaybackContextResponseTokenizer, BulkGetPlaybackContextTokenizer> = RequestBuilder<BulkPlaybackContextResponse, BulkPlaybackContextResponse.BulkPlaybackContextResponseTokenizer, BulkGetPlaybackContextTokenizer>(service: "asset", action: "bulkGetPlaybackContext")
	...
	public class GetPlaybackManifestTokenizer: ClientTokenizer  {
	...
	public static func getPlaybackManifest(assetId: String, assetType: AssetType, contextDataParams: PlaybackContextOptions) -> RequestBuilder<PlaybackContext, PlaybackContext.PlaybackContextTokenizer, GetPlaybackManifestTokenizer> {
		return getPlaybackManifest(assetId: assetId, assetType: assetType, contextDataParams: contextDataParams, sourceType: nil)
	}

	/**  This action delivers all data relevant for player  */
	public static func getPlaybackManifest(assetId: String, assetType: AssetType, contextDataParams: PlaybackContextOptions, sourceType: String?) -> RequestBuilder<PlaybackContext, PlaybackContext.PlaybackContextTokenizer, GetPlaybackManifestTokenizer> {
		let request: RequestBuilder<PlaybackContext, PlaybackContext.PlaybackContextTokenizer, GetPlaybackManifestTokenizer> = RequestBuilder<PlaybackContext, PlaybackContext.PlaybackContextTokenizer, GetPlaybackManifestTokenizer>(service: "asset", action: "getPlaybackManifest")
			.setParam(key: "assetId", value: assetId)
			.setParam(key: "assetType", value: assetType.rawValue)
			.setParam(key: "contextDataParams", value: contextDataParams)
			.setParam(key: "sourceType", value: sourceType)
	...
	public class GroupRepresentativeListTokenizer: ClientTokenizer  {
		
		public func groupBy<T: AssetGroupBy.AssetGroupByTokenizer>() -> T {
			return T(self.append("groupBy"))
		}
		
		public var unmatchedItemsPolicy: BaseTokenizedObject {
			get {
				return self.append("unmatchedItemsPolicy") 
			}
		}
		
		public func orderBy<T: BaseAssetOrder.BaseAssetOrderTokenizer>() -> T {
			return T(self.append("orderBy"))
		}
		
		public func filter<T: ListGroupsRepresentativesFilter.ListGroupsRepresentativesFilterTokenizer>() -> T {
			return T(self.append("filter"))
		}
		
		public func selectionPolicy<T: RepresentativeSelectionPolicy.RepresentativeSelectionPolicyTokenizer>() -> T {
			return T(self.append("selectionPolicy"))
		}
	...
	public static func groupRepresentativeList(groupBy: AssetGroupBy, unmatchedItemsPolicy: UnmatchedItemsPolicy) -> RequestBuilder<AssetListResponse, AssetListResponse.AssetListResponseTokenizer, GroupRepresentativeListTokenizer> {
		return groupRepresentativeList(groupBy: groupBy, unmatchedItemsPolicy: unmatchedItemsPolicy, orderBy: nil)
	}

	public static func groupRepresentativeList(groupBy: AssetGroupBy, unmatchedItemsPolicy: UnmatchedItemsPolicy, orderBy: BaseAssetOrder?) -> RequestBuilder<AssetListResponse, AssetListResponse.AssetListResponseTokenizer, GroupRepresentativeListTokenizer> {
		return groupRepresentativeList(groupBy: groupBy, unmatchedItemsPolicy: unmatchedItemsPolicy, orderBy: orderBy, filter: nil)
	}

	public static func groupRepresentativeList(groupBy: AssetGroupBy, unmatchedItemsPolicy: UnmatchedItemsPolicy, orderBy: BaseAssetOrder?, filter: ListGroupsRepresentativesFilter?) -> RequestBuilder<AssetListResponse, AssetListResponse.AssetListResponseTokenizer, GroupRepresentativeListTokenizer> {
		return groupRepresentativeList(groupBy: groupBy, unmatchedItemsPolicy: unmatchedItemsPolicy, orderBy: orderBy, filter: filter, selectionPolicy: nil)
	}

	public static func groupRepresentativeList(groupBy: AssetGroupBy, unmatchedItemsPolicy: UnmatchedItemsPolicy, orderBy: BaseAssetOrder?, filter: ListGroupsRepresentativesFilter?, selectionPolicy: RepresentativeSelectionPolicy?) -> RequestBuilder<AssetListResponse, AssetListResponse.AssetListResponseTokenizer, GroupRepresentativeListTokenizer> {
		return groupRepresentativeList(groupBy: groupBy, unmatchedItemsPolicy: unmatchedItemsPolicy, orderBy: orderBy, filter: filter, selectionPolicy: selectionPolicy, pager: nil)
	}

	/**  Returns assets deduplicated by asset metadata (or supported asset&amp;#39;s
	  property).  */
	public static func groupRepresentativeList(groupBy: AssetGroupBy, unmatchedItemsPolicy: UnmatchedItemsPolicy, orderBy: BaseAssetOrder?, filter: ListGroupsRepresentativesFilter?, selectionPolicy: RepresentativeSelectionPolicy?, pager: FilterPager?) -> RequestBuilder<AssetListResponse, AssetListResponse.AssetListResponseTokenizer, GroupRepresentativeListTokenizer> {
		let request: RequestBuilder<AssetListResponse, AssetListResponse.AssetListResponseTokenizer, GroupRepresentativeListTokenizer> = RequestBuilder<AssetListResponse, AssetListResponse.AssetListResponseTokenizer, GroupRepresentativeListTokenizer>(service: "asset", action: "groupRepresentativeList")
			.setParam(key: "groupBy", value: groupBy)
			.setParam(key: "unmatchedItemsPolicy", value: unmatchedItemsPolicy.rawValue)
			.setParam(key: "orderBy", value: orderBy)
			.setParam(key: "filter", value: filter)
			.setParam(key: "selectionPolicy", value: selectionPolicy)
	...
	public class ListPersonalSelectionTokenizer: ClientTokenizer  {
		
		public func filter<T: PersonalAssetSelectionFilter.PersonalAssetSelectionFilterTokenizer>() -> T {
			return T(self.append("filter"))
		}
	}

	/**  Returns recent selected assets  */
	public static func listPersonalSelection(filter: PersonalAssetSelectionFilter) -> RequestBuilder<AssetListResponse, AssetListResponse.AssetListResponseTokenizer, ListPersonalSelectionTokenizer> {
		let request: RequestBuilder<AssetListResponse, AssetListResponse.AssetListResponseTokenizer, ListPersonalSelectionTokenizer> = RequestBuilder<AssetListResponse, AssetListResponse.AssetListResponseTokenizer, ListPersonalSelectionTokenizer>(service: "asset", action: "listPersonalSelection")
			.setParam(key: "filter", value: filter)
	...
	public class SemanticSearchTokenizer: ClientTokenizer  {
	...
	public static func semanticSearch(query: String) -> RequestBuilder<AssetListResponse, AssetListResponse.AssetListResponseTokenizer, SemanticSearchTokenizer> {
		return semanticSearch(query: query, refineQuery: false)
	}

	public static func semanticSearch(query: String, refineQuery: Bool?) -> RequestBuilder<AssetListResponse, AssetListResponse.AssetListResponseTokenizer, SemanticSearchTokenizer> {
		return semanticSearch(query: query, refineQuery: refineQuery, size: 10)
	}

	/**  Search for assets using semantic similarity to a natural language query, with
	  optional query refinement using LLM.  */
	public static func semanticSearch(query: String, refineQuery: Bool?, size: Int?) -> RequestBuilder<AssetListResponse, AssetListResponse.AssetListResponseTokenizer, SemanticSearchTokenizer> {
		let request: RequestBuilder<AssetListResponse, AssetListResponse.AssetListResponseTokenizer, SemanticSearchTokenizer> = RequestBuilder<AssetListResponse, AssetListResponse.AssetListResponseTokenizer, SemanticSearchTokenizer>(service: "asset", action: "semanticSearch")
			.setParam(key: "query", value: query)
			.setParam(key: "refineQuery", value: refineQuery)
			.setParam(key: "size", value: size)
	...
	public class WatchBasedRecommendationsListTokenizer: ClientTokenizer  {
	...
	public static func watchBasedRecommendationsList(profileId: Int64) -> RequestBuilder<AssetListResponse, AssetListResponse.AssetListResponseTokenizer, WatchBasedRecommendationsListTokenizer> {
		let request: RequestBuilder<AssetListResponse, AssetListResponse.AssetListResponseTokenizer, WatchBasedRecommendationsListTokenizer> = RequestBuilder<AssetListResponse, AssetListResponse.AssetListResponseTokenizer, WatchBasedRecommendationsListTokenizer>(service: "asset", action: "watchBasedRecommendationsList")
			.setParam(key: "profileId", value: profileId)
