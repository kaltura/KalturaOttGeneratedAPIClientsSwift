...
public final class AssetService{
	...
	public class SemanticSearchTokenizer: ClientTokenizer  {
		...
		public func searchParams<T: SemanticSearchParams.SemanticSearchParamsTokenizer>() -> T {
	...
	public static func semanticSearch(searchParams: SemanticSearchParams) -> RequestBuilder<AssetListResponse, AssetListResponse.AssetListResponseTokenizer, SemanticSearchTokenizer> {
