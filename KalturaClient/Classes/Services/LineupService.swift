...
public final class LineupService{
	...
	public static func invalidate() -> RequestBuilder<Bool, BaseTokenizedObject, InvalidateTokenizer> {
		let request: RequestBuilder<Bool, BaseTokenizedObject, InvalidateTokenizer> = RequestBuilder<Bool, BaseTokenizedObject, InvalidateTokenizer>(service: "lineup", action: "invalidate")
