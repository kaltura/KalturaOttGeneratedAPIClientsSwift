...
public final class RecordingService{
	...
	public static func immediateRecord(assetId: Int64) -> RequestBuilder<ImmediateRecording, ImmediateRecording.ImmediateRecordingTokenizer, ImmediateRecordTokenizer> {
		return immediateRecord(assetId: assetId, endPadding: nil)
	}

	/**  Immediate Record  */
	public static func immediateRecord(assetId: Int64, endPadding: Int?) -> RequestBuilder<ImmediateRecording, ImmediateRecording.ImmediateRecordingTokenizer, ImmediateRecordTokenizer> {
	...
	public static func stop(assetId: Int64, id: Int64) -> RequestBuilder<Recording, Recording.RecordingTokenizer, StopTokenizer> {
