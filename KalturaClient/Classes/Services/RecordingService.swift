...
public final class RecordingService{
	...
	public class ImmediateRecordTokenizer: ClientTokenizer  {
	...
	public static func immediateRecord(assetId: Int64, epgChannelId: Int64) -> RequestBuilder<ImmediateRecording, ImmediateRecording.ImmediateRecordingTokenizer, ImmediateRecordTokenizer> {
		return immediateRecord(assetId: assetId, epgChannelId: epgChannelId, endPadding: nil)
	}

	/**  Immediate Record  */
	public static func immediateRecord(assetId: Int64, epgChannelId: Int64, endPadding: Int?) -> RequestBuilder<ImmediateRecording, ImmediateRecording.ImmediateRecordingTokenizer, ImmediateRecordTokenizer> {
		let request: RequestBuilder<ImmediateRecording, ImmediateRecording.ImmediateRecordingTokenizer, ImmediateRecordTokenizer> = RequestBuilder<ImmediateRecording, ImmediateRecording.ImmediateRecordingTokenizer, ImmediateRecordTokenizer>(service: "recording", action: "immediateRecord")
			.setParam(key: "assetId", value: assetId)
			.setParam(key: "epgChannelId", value: epgChannelId)
			.setParam(key: "endPadding", value: endPadding)
	...
	public class StopTokenizer: ClientTokenizer  {
		...
		public var householdRecordingId: BaseTokenizedObject {
			get {
				return self.append("householdRecordingId") 
			}
		}
	}

	/**  Stop ongoing household recording  */
	public static func stop(assetId: Int64, epgChannelId: Int64, householdRecordingId: Int64) -> RequestBuilder<Recording, Recording.RecordingTokenizer, StopTokenizer> {
		let request: RequestBuilder<Recording, Recording.RecordingTokenizer, StopTokenizer> = RequestBuilder<Recording, Recording.RecordingTokenizer, StopTokenizer>(service: "recording", action: "stop")
			.setParam(key: "assetId", value: assetId)
			.setParam(key: "epgChannelId", value: epgChannelId)
			.setParam(key: "householdRecordingId", value: householdRecordingId)
