...
public final class OttUserService{
	...
	public class MfaLoginTokenizer: ClientTokenizer  {
	...
	public static func mfaLogin(partnerId: Int, token: String) -> RequestBuilder<LoginResponse, LoginResponse.LoginResponseTokenizer, MfaLoginTokenizer> {
		return mfaLogin(partnerId: partnerId, token: token, username: nil)
	}

	public static func mfaLogin(partnerId: Int, token: String, username: String?) -> RequestBuilder<LoginResponse, LoginResponse.LoginResponseTokenizer, MfaLoginTokenizer> {
		return mfaLogin(partnerId: partnerId, token: token, username: username, password: nil)
	}

	public static func mfaLogin(partnerId: Int, token: String, username: String?, password: String?) -> RequestBuilder<LoginResponse, LoginResponse.LoginResponseTokenizer, MfaLoginTokenizer> {
		return mfaLogin(partnerId: partnerId, token: token, username: username, password: password, extraParams: nil)
	}

	public static func mfaLogin(partnerId: Int, token: String, username: String?, password: String?, extraParams: Dictionary<String, StringValue>?) -> RequestBuilder<LoginResponse, LoginResponse.LoginResponseTokenizer, MfaLoginTokenizer> {
		return mfaLogin(partnerId: partnerId, token: token, username: username, password: password, extraParams: extraParams, udid: nil)
	}

	/**  login based on MFA token.  */
	public static func mfaLogin(partnerId: Int, token: String, username: String?, password: String?, extraParams: Dictionary<String, StringValue>?, udid: String?) -> RequestBuilder<LoginResponse, LoginResponse.LoginResponseTokenizer, MfaLoginTokenizer> {
		let request: RequestBuilder<LoginResponse, LoginResponse.LoginResponseTokenizer, MfaLoginTokenizer> = RequestBuilder<LoginResponse, LoginResponse.LoginResponseTokenizer, MfaLoginTokenizer>(service: "ottuser", action: "mfaLogin")
			.setParam(key: "partnerId", value: partnerId)
	...
	public class ResendMfaTokenTokenizer: ClientTokenizer  {
	...
	public static func resendMfaToken(partnerId: Int) -> RequestBuilder<ResendMfaTokenResponse, ResendMfaTokenResponse.ResendMfaTokenResponseTokenizer, ResendMfaTokenTokenizer> {
		return resendMfaToken(partnerId: partnerId, username: nil)
	}

	public static func resendMfaToken(partnerId: Int, username: String?) -> RequestBuilder<ResendMfaTokenResponse, ResendMfaTokenResponse.ResendMfaTokenResponseTokenizer, ResendMfaTokenTokenizer> {
		return resendMfaToken(partnerId: partnerId, username: username, password: nil)
	}

	public static func resendMfaToken(partnerId: Int, username: String?, password: String?) -> RequestBuilder<ResendMfaTokenResponse, ResendMfaTokenResponse.ResendMfaTokenResponseTokenizer, ResendMfaTokenTokenizer> {
		return resendMfaToken(partnerId: partnerId, username: username, password: password, extraParams: nil)
	}

	/**  resend MFA Token for the user.  */
	public static func resendMfaToken(partnerId: Int, username: String?, password: String?, extraParams: Dictionary<String, StringValue>?) -> RequestBuilder<ResendMfaTokenResponse, ResendMfaTokenResponse.ResendMfaTokenResponseTokenizer, ResendMfaTokenTokenizer> {
		let request: RequestBuilder<ResendMfaTokenResponse, ResendMfaTokenResponse.ResendMfaTokenResponseTokenizer, ResendMfaTokenTokenizer> = RequestBuilder<ResendMfaTokenResponse, ResendMfaTokenResponse.ResendMfaTokenResponseTokenizer, ResendMfaTokenTokenizer>(service: "ottuser", action: "resendMfaToken")
			.setParam(key: "partnerId", value: partnerId)
			.setParam(key: "username", value: username)
			.setParam(key: "password", value: password)
			.setParam(key: "extraParams", value: extraParams)
	...
	public class RetryDeleteTokenizer: ClientTokenizer  {
		
		public func request<T: RetryDeleteRequest.RetryDeleteRequestTokenizer>() -> T {
			return T(self.append("request"))
		}
	}

	/**  Retry delete OTT user entities by retention.  */
	public static func retryDelete(request: RetryDeleteRequest) -> NullRequestBuilder<RetryDeleteTokenizer> {
		let request: NullRequestBuilder<RetryDeleteTokenizer> = NullRequestBuilder<RetryDeleteTokenizer>(service: "ottuser", action: "retryDelete")
