...
public final class UsageModuleService{
	...
	public class ListTokenizer: ClientTokenizer  {
		...
		public func filter<T: UsageModuleFilter.UsageModuleFilterTokenizer>() -> T {
	...
	public static func list(filter: UsageModuleFilter?) -> RequestBuilder<UsageModuleListResponse, UsageModuleListResponse.UsageModuleListResponseTokenizer, ListTokenizer> {
	...
	/**  Update usage module  */
	public static func update(id: Int, usageModule: UsageModule) -> RequestBuilder<UsageModule, UsageModule.UsageModuleTokenizer, UpdateTokenizer> {
		let request: RequestBuilder<UsageModule, UsageModule.UsageModuleTokenizer, UpdateTokenizer> = RequestBuilder<UsageModule, UsageModule.UsageModuleTokenizer, UpdateTokenizer>(service: "usagemodule", action: "update")
			.setParam(key: "id", value: id)
			.setParam(key: "usageModule", value: usageModule)
